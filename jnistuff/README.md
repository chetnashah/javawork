...
## Some supporting libraries in this space
...
**Generated header file is where we should implement our native/cpp logic**
```
//Prompt.h
...
**The generated header file is later compiled to form a shared library**
